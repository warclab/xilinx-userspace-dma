...
clean: driver_clean examples_clean libaxidma_clean
	rm -rf $(OUTPUT_DIR)
...
help:
	...
	@printf "\t    Cleans up files generated by compiling the examples or the\n"
